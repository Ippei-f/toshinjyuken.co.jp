...
<div class="info">
  ...
  <?php if (date('Y-m-d H:i:s') < '2022-09-26 00:00:00') :?>
	...
	【営業時間】9時〜18時 　【定休日】土日祝</p>
  <address>
  <span class="bold">＜JPオフィス＞</span><br>
  〒450-6321 名古屋市中村区名駅1-1-1 JPタワー名古屋21階（名古屋駅前支店）<br>
  <span class="bold">＜名駅オフィス＞</span><br>
  〒453-0014 名古屋市中村区則武1-10-6 ノリタケ第一ビル6階<br>
...
<script>
	ScrollReveal().reveal('.front', { delay: 300, duration: 1600, origin: 'front', reset: false , mobile: true });
</script>
<?php endif; ?>
<?php if ( is_page('job') ) : ?>
