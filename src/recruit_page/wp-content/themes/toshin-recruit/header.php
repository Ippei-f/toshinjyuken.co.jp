...
<head>
	...
	<script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-K7Z9WB0EM8'); </script>
...
<?php global $body_id; if(!empty($body_id)): ?>
