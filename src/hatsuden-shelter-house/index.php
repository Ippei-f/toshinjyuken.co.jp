...
foreach(CMS_SETUP('search') as $key => $sysdata){
	...
	if($sysdata[9]<1){continue;}//ピックアップのみ表示
	CMS_DATA_REPLACE();
...
?>
<div class="slide_set<?php echo $class; ?>"><div class="arrow L"><img src="images/common/arrow-slide.svg"></div><div class="slide_mode">
...
foreach($search_arr as $key => $vv){
	...
	//テキスト設定
	if(!is_array($vv[6])){$vv[6]=array($vv[6]);}
	$vv[6][0]=trim($vv[6][0]);
...
</div><div class="arrow R"><img src="images/common/arrow-slide.svg"></div></div>
</div>
...
TOP_CAUTION('※3.3kW搭載の場合でのシミュレーション ※太陽光発電の自家消費の電気代＋売電収入※2023年売電単価16円／kWhで計算
...
東新住建は末永く安心して暮らしていただくため、耐震・耐火性など優れた特性をもつ「2×4（ツーバイフォー）工法」を採用しています。2×4工法は、地震の衝撃を天井・壁・床の6面全体でバランス良く吸収するため水平・垂直、両方からの力に優れた強さを発揮します。</div>
</div>
<div class="LH175">
...
<div class="flex3">
<div>
<h3 class="subt_memo fontS4"><img src="images/top/icon-memo.svg"><div>2×4パネルは<br>すべて専属工場生産</div></h3>
...
<div class="b_frame">
<h3><div>2014年より全棟に<br>国産材2×4を標準使用。</div><img src="images/top/icon-japan.svg"></h3>
<div class="LH175 fontS7">国の重要課題である国産材の普及に貢献し、<br>これまでに約2,000棟建築しています。</div>
</div>
</div>
</div>
<?php echo $temp_frame_rokkaku[1]; ?></div>
</div>
<!-- *** -->
<?php echo $temp_box_search; ?>
<!-- *** -->
...
<h3 class="subt_memo fontS4"><img src="images/top/icon-memo.svg"><div>地元の採石場を活用。<br>地産地消の技術です。</div></h3>
...
<?php echo $temp_frame_rokkaku[0]; ?>
<h3 class="subt_memo fontS4"><img src="images/top/icon-memo.svg"><div>地盤20年保証</div></h3>
...
?>
<div class="btn_box">
<div class="t pc_br_del fontS3">これだけでは実現できない<br>高品質低価格の秘密が<br>まだまだあります。</div>
...
<div class="top_qa textLJ"><div class="Wbase W720 sp_W330">
<!-- qa -->
