...
<tr>
	<th>エリア</th>
	<td><?php
	INPUT_CATEGORY($area_num,10);//,array('onclick'=>'T_CHANGE')
	?></td>
</tr>
<?php
...
<tr>
	<th>ブランド</th>
	<td><?php
	INPUT_CATEGORY($categoryArr_brand,13,array('defnum'=>0));//,array('onclick'=>'T_CHANGE')
	?></td>
</tr>
<?php
function INPUT_CATEGORY($list,$num,$prm=array()){
	...
	foreach($list as $k => $v){
		...
		$defnum=(!empty($prm['defnum'])||$prm['defnum']===0)?$prm['defnum']:1;
