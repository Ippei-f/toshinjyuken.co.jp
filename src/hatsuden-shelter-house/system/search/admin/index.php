...
<table class="borderTable03">
	   ...
	   <th style="width:13%">登録日</th>
		 <th style="width:5em">エリア</th>
		 <th style="width:5em">カテゴリ</th>
		 <th style="width:5em">ブランド</th>
		 <?php
		 /*
...
?>
	   ...
	   <td nowrap="nowrap">
		...
		echo $str_set.'<div style="clear:both;"></div>'.chr(10);
		
		if($linesArray[9]>0){
			echo '<div class="koukai" style="color:#D00;"><b>PICKUP</b></div>'.chr(10);
		}
	   ...
	   <td style="font-size: 90%;"><?php echo date2FormatDate($dateType,$linesArray[1]);?><?php echo ($weekDsp == 1) ? ' ('.$weekArray[date('w',strtotime($linesArray[1]))].')' : '';?></td>
		 <td style="font-size: 90%;"><?php echo TextToKanma($area_num[$linesArray[10]]);?></td>
		 <td style="font-size: 90%;"><?php echo TextToKanma($categoryArr[$linesArray[3]]);?></td>
		  <td style="font-size: 90%;"><?php echo TextToKanma($categoryArr_brand[$linesArray[13]]);?></td>
		 <?php
		 /*
