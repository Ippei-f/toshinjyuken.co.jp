...
<!-- ** -->
<div class="top_slider"><div class="wideslider borderbox">
<?php
...
?>
<div class="top_sec02 pc_content_box<?php echo $addclass?' first':''; ?>"><div class="Wbase W1200">
<div class="top_subt"><div class="en">RECOMMEND</div><h2>おすすめの物件</h2></div>
...
function SEARCH_SLIDE_BTN(add,obj){
	...
	obj.find('.sp_slide_mode').animate({scrollLeft:num*w},250,"swing",function(){
		//$(this).dequeue();
	});
}
...
?>
<style>
.top_lp_box_202503 .content_box{background-color: transparent;}
.top_bnr_zeroyen_set a::before{border-color:#525a6f;}
.top_movie .set {
	display: flex;
...
<div class="title"><h3>NEWS</h3><div class="font_yugo">お知らせ</div></div>
<ul class="font_yugo">
<?php
$arr=array();
$cnt=0;
...
.bnr_voice .frame{border:solid min(8px,max(4px,calc(1vw * 4 / 3.75))) #FFF;}
</style>
...
<!-- *** -->
<div class="top_sec03 content_box"><div class="Wbase W1200">
<div class="top_subt"><div class="en">COLUMN</div><h2>コラム</h2></div>
<ul class="LS_list">
<?php
$max=4;
$cnt=0;
...
<!-- *** -->
<div class="top_sec04 content_box"><div class="Wbase W1200">
...
<!-- *** -->
<div class="top_sec05 content_box bg_FFF"><div class="Wbase W1200">
