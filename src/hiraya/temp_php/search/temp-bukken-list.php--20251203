...
if($sysdata[3]!=999){
	$add['href']=' href="'.$link_list['物件詳細'][0].'?id='.$sysdata[0].'&name='.$sysdata[2].'"';
	if($sysdata[3]==1){
		//会員
...
$img='<a class="pos_rel bg_cover pic'.$add['class'].'"'.$add['bg'].$add['href'].'><img src="'.$kaisou.'images/common/clear-W270H150.png"'.$add['kaiin'].'>'.$add['new'].'</a>';
