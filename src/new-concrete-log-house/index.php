...
<!-- ** -->
<main>
<section class="lp_head"><div class="Wbase">
...
<!-- *** -->
<section class="top_sec01"><div class="Wbase">
<div class="catch"><div>新たなる住宅への挑戦。</div></div>
...
?>
<section class="top_modelhouse c_pad"><div class="Wbase" w="960">
...
<!-- Wbase -->
<div class="Wbase"><div class="subt"><img src="_assets/img/top/icon-strong.svg"><h2 class="font_pw">従来のコンクリートの約10倍！
高度な断熱性能を実現。</h2></div></div>
<div class="c_pad"><div class="Wbase">

<div class="flex sp_gap15">
<div order="2">ALCコンクリート外壁の厚みは37mm。その内部にはたくさんの気泡が形成されています。この空気の層が熱を通しにくい性質を生み出します。</div>
<div order="1"><div class="flex2 vanish_branch" A1>
...
<div class="flex sp_gap15">
<div order="2" class="t">抜群の断熱性で快適な暮らしを守ります。室内の空調効率が良いので省エネにも繋がります。<div class="flex2 sp_vanish" A2><img src="_assets/img/top/sec02-deco1.svg"><img src="_assets/img/top/sec02-deco2.svg"></div></div>
<div order="1"><?php echo IMG_TAG_PCSP('top/sec02-A2.jpg'); ?><div class="mini t pc_vanish">左の外壁材は外気によって内側まで冷やされているのに対し、右のALCコンクリートは熱を保っているのが分かります。</div></div>
</div>
<h3 class="beta">火を寄せ付けない外壁。</h3>
<div class="flex" A3>
<div order="1" class="t"><div class="pc_vanish"><img src="_assets/img/top/sec02-A3-sp.png"></div><div class="pc_vanish"><h4>驚きの耐火性を実現。</h4></div>外壁が直接火にさらされても、内側は引火危険温度まで上がりにくく、類焼の危険性を減らせます。<div class="sp_vanish"><img src="_assets/img/top/sec02-A3-pc.png" class="mgn"></div></div>
<div order="2" tume><div><img src="_assets/img/top/sec02-A4-pc.png"></div><div class="mini t">図の条件には、風向きや風速など風の条件は含まれていません。目安としてご覧ください。一般に家屋火災は1000℃を超え、3ｍ離れた位置でも約840℃に達します。</div></div>
</div>
<div class="movie">
<?php
$arr=array
...
<!-- Wbase -->
<div class="Wbase"><div class="subt"><img src="_assets/img/top/icon-light.svg"><h2 class="font_pw">水に浮くほど軽い！<br class="sp_vanish">この軽さが<br class="pc_vanish">地震時の建物への負担を軽減。</h2></div></div>
<div class="c_pad"><div class="Wbase">

<div class="flex">
<div order="1"><?php echo IMG_TAG_PCSP('top/sec02-B1.png'); ?><div class="t pc_vanish">※気乾比重0.6（水を１とした場合）</div><div class="t">壁の質量が大きいほど、地震の際に家にかかる負担は大きくなります。水に浮くほどのALCコンクリートは、地震時の建物への負担を軽減します。また、揺れによる衝撃を目地で吸収する取付け構造なので、試験でも安全性が確認されています。</div></div>
<div order="2"><div class="flex2 vanish_branch" B2>
<img src="_assets/img/top/sec02-B2-pc.jpg">
<div class="pc_vanish"><img src="_assets/img/top/sec02-B2a-sp.jpg"><h4>面内変形性能試験</h4></div>
...
<div order="1"><div class="flex2 vanish_branch" B3><img src="_assets/img/top/sec02-B3-sp.jpg"><img src="_assets/img/top/sec02-B4-pc.jpg"><img src="_assets/img/top/sec02-B4-sp.jpg"></div><div class="t">パワーボード内のメタルラス網が強度を充分に補完して、基準風速38m/sにも耐えられる強度を保ちます。基準風速38m/sは瞬間風速57m/s相当。瞬間風速54m/sではトラックも横転する強風ですがそれ以上の風に耐えられる強度を保持します。</div></div>
</div>

</div></div>

<!-- Wbase -->
<div class="Wbase"><div class="subt"><img src="_assets/img/top/icon-quiet.svg"><h2 class="font_pw">駅ホームの防音壁に使用されるほど<br class="sp_vanish">優れた遮音性能。</h2></div></div>
<div class="c_pad"><div class="Wbase">
...
<div class="flex sp_gap15">
<div class="t" order="2"><div class="pc_vanish"><h4>外壁材単体での遮音効果。</h4>※単体遮音性能は当社実験値です。</div>ALCコンクリート単体でも優れた遮音性を保ちます。一般的に音が10dB低減すると、半分の音量になったように感じると言われています。ALCコンクリートは単体でも約30dBの騒音を低減します。</div>
...
<!-- Wbase -->
<div class="Wbase"><div class="subt"><img src="_assets/img/top/icon-beauty.svg"><h2 class="font_pw">60年間張り替えが不要。
永く美しい外観を保ちます。</h2></div></div>
<div class="c_pad"><div class="Wbase">
...
<div class="flex">
<div order="1">
<div><img src="_assets/img/top/sec02-D4-pc.jpg"></div><div class="t">ALCコンクリートは、自然素材を使用した無機建材。シックハウス症候群の原因物質やアスベストは一切含みません。廃材から作られるリサイクル材料は、住環境や農業で使用される環境に優しい原料です。田畑の質の向上や家畜の飼育環境の改善にも利用されています。</div></div>
<div order="2" tume>
<div><img src="_assets/img/top/sec02-D5-pc.jpg" class="mgn sp_border"></div><div class="t">製造工程で出る端材や集塵粉、規格外品などをもう一度粉砕し、再生原材料としてリサイクルしています。それにより、原材料のムダを大幅に省き、自然素材を大切に製品化しています。</div></div>
</div>
...
<!-- *** -->
<section class="top_sec04 c_pad"><div class="Wbase">
...
.bnr_voice img{object-fit: cover;}
.bnr_voice a > *{
	position: absolute;
	top: 0;
	left: 0;
...
.bnr_voice a > .frame + div img{height:100%;}
</style>
...
jQuery(window).load(function(){
	...
	slide_img.on('dragstart',function(){$(this).addClass('drag');});
	slide_img.on('mouseleave',function(){$(this).removeClass('drag');});
...
<div class="pop"><div class="dark"><div class="flex"><div class="frame"><?php //echo ASSET_IMG('common/pop-close.svg'); ?></div></div></div></div>
<!-- ** -->
<?php TEMP_FOOTER(); ?>
<!-- * -->
</div>
