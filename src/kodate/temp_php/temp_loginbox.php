...
<div class="part_top">
<img src="<?php echo $kaisou; ?>images/common/icon-members_only.svg" class="dpB icon_members_only">
<div class="LH175 fontP120 login_text"><?php echo WORD_BR('こちらは<strong>東新住建の家
会員限定ページ</strong>となります。
...
<a href="<?php echo $link_list['会員登録'][0] ;?>" class="login_member_btn font_bold textC"><?php echo WORD_BR('東新住建の家会員登録は
こちらから'); ?></a>
</div></div>
