...
<head>
	...
	<style>
		.voice_dt {
			padding: min(110px, max(50px, 11vw)) 0 min(150px, max(80px, 15vw));
		}
		...
		.voice_dt .t h2 {
			font-size: min(calc(1rem * 22 / 16), calc(1vw * 18 / 3.75));
			font-weight: 700;
			line-height: 1.5em;
		}
		...
		.voice_dt .set .T h3 {
			font-size: max(18px, calc(1rem * 18 / 16));
		}
		...
		.voice_dt .back {
			padding: min(80px, max(40px, 8vw)) 0 0;
		}
	</style>
</head>
		...
		<div class="content_box">
			...
			?>
				<div class="Wbase voice_dt">
					<div class="cb">
						<div class="case">CASE<?php echo $case_num; ?></div><?php echo $add['brand']; ?>
					</div>
					<div class="t">
						<h2><?php echo $v[2]; ?></h2>
