...
//販売済みチェック - 404エラー表示
if(!is_array($sysdata[3])){$sysdata[3]=array($sysdata[3]);}
...
.error-page h1 { font-size: 48px; color: #ccc; margin-bottom: 20px; }
.error-page p { font-size: 18px; color: #666; margin-bottom: 40px; }
.error-page a { display: inline-block; padding: 15px 40px; background: #333; color: #fff; text-decoration: none; }
.error-page a:hover { background: #555; }
</style>
</head>
<body>
...
if(!is_array($sysdata[24])){$sysdata[24]=array($sysdata[24]);}
...
@media screen and (min-width: 1000px) {
	.local_top1 tr > *:nth-child(1){padding-right: 1em;}
...
@media screen and (max-width: 999px) {
	.local_top1 tr > *:nth-child(1){padding-bottom: 0.75em;}
	.local_top2 tr > *:nth-child(1){padding-bottom: 0.5em;}
}
.local_mainpic{
	width:800px;
	max-width: 100%;
...
@media screen and (min-width: 1000px) {
	...
	.local_mainpic .picbox2 > * > div{padding: 1% 0;}
	.local_mainpic .picbox2:last-child > * > div,
	.local_mainpic > * .picbox2:last-child > * > div{padding-bottom: 0;}
	.local_mainpic .picbox3 .pad{width:1%;}
}
@media screen and (max-width: 999px) {
	.local_mainpic .picbox1 > *{text-align: center;}
	.local_mainpic .picbox1 > *:nth-child(1){}
	.local_mainpic .picbox1 > *:nth-child(2){padding-top: 0;}
	.local_mainpic .picbox2,
	.local_mainpic .picbox3 td{margin-top: 1%;}
}
.local_kukakubox{
...
.local_kukakubox .kukaku_top tr > *:nth-child(2) span a:nth-child(2) img{margin-left: 0.5em;}
...
@media screen and (min-width: 1000px) {
	.local_kukakubox .kukaku_top tr > *:nth-child(1){width: 6em;}
	.local_kukakubox .kukaku_top tr > *:nth-child(3){width: 19em;}
	.local_kukakubox .kukaku_top tr > *:nth-child(4){width: 12em;}
}
@media screen and (max-width: 999px) {
	.local_kukakubox .kukaku_top tr > *:nth-child(1){float: left; width:59%;font-size: 240%;}
	.local_kukakubox .kukaku_top tr > *:nth-child(2){float: right; width:40%;}
	.local_kukakubox .kukaku_top tr > *:nth-child(2) span{margin-top: 1.25em;}
	.local_kukakubox .kukaku_top tr > *:nth-child(3){clear: both;}
	.local_kukakubox .kukaku_top tr > *:nth-child(4){margin-top: 0.5em;}
}
...
.contactbtn{margin: auto;}
.contactbtn .btnbox{width:14.5em;}
.contactbtn .pad{width:1em;}
@media screen and (max-width: 999px) {
	.contactbtn *{margin: auto;}
	.contactbtn .pad{height:1em;}
}
.local_gal_select{
	padding-top: 1em;
	margin-bottom: 35px;
...
.local_gal_select tr > *{width:50%;}
.local_gal_select tr > * > div{
	height:2em;
	text-align: center;
}
.local_gal_select tr > .detail_menu1 *{right:0;}
.local_gal_select tr > .detail_menu2 *{left:0;}
.local_gal_select tr > * > div.selected{color:#FFF;}
/*
...
.local_gal_select tr > * > div.selected .skew{background-color: #F63402;}
.local_gal_select tr .detail_menu1 div.selected .skew{border-right: solid 1px #000;}
.local_gal_select tr .detail_menu2 div.selected .skew{border-left: solid 1px #000;}
...
.local_gal_select tr > * a{z-index: 3;}
...
.local_gal_select tr > .detail_menu1 .sideline{left: -1px;right:auto;border-left: solid 1px #000;}
.local_gal_select tr > .detail_menu2 .sideline{right: -1px;left:auto;border-right: solid 1px #000;}
...
@media screen and (min-width: 1000px) {
	...
	.local_gallerybox .photo.p1{float: left;clear:both;}
	.local_gallerybox .photo.p2{float:right;}
	.local_gallerybox .photo:nth-child(n+3){margin-top: 1em;}
}
@media screen and (max-width: 999px) {
	.local_gallerybox .photo:nth-child(n+2){margin-top: 1em;}
}
.local_gaiyoubox{
	padding: 0 1em;
}
...
@media screen and (max-width: 999px) {
	.local_gaiyoubox * tr:last-child > *:last-child{padding-bottom: 1em;}
}
.local_shuuhenbox{
	padding: 0 1em;
	padding-top: 90px;
...
<?php
if(!is_array($sysdata[19])){$sysdata[19]=array($sysdata[19]);}
if($sysdata[19][0]!=''){
	echo '<div class="local_subtitle"><div>'.$sysdata[19][0].'</div></div>';
}
?>
<table border="0" cellpadding="0" cellspacing="0" class="sp_tblbreak local_top1"><tr>
...
<table border="0" cellpadding="0" cellspacing="0" class="sp_tblbreak local_top2"><tr>
<td>交通：</td>
...
<style>
.local_edit_comment a{display: inline-block;}
.local_jump_menu{
	margin-bottom: 50px;
	padding: 1em;
}
.local_jump_menu a:hover{color:#F63402;}
</style>
<?php
...
<tr class="picbox2"><td colspan="5"><div><img src="images/common/clear-W800H530.png" class="bg_cover" style="background-image: url(<?php echo $sysdata['order'][0]; ?>);"></div></td></tr>
<?php
//外観写真小・PHP7.0対応
$arr=array();
for($i=1;$i<=3;$i++){
...
if(!is_array($sysdata[10])){$sysdata[10]=array($sysdata[10]);}

//print_r($sysdata[10]);
$str='';
foreach($sysdata[10] as $k => $v){
	if($sysdata[9][($k*4)]==''){continue;}
	if($v!=''){
...
?>
<div class="local_kukakubox"><div class="W1000 Wmax100per mgnAuto">
<table border="0" cellpadding="0" cellspacing="0" class="kukaku_top LH175 sp_tblbreak"><tr>
...
if(!empty($sysdata[9][$ik])){
	if(($t=$sysdata[9][$ik])!=''){echo $t;}
}
else{$sysdata[9][$ik]='';}
?></td>
<td><div>販売価格（税込）</div><strong><span><?php
//PHP7.0対応
$ik=$i+2;
if(!empty($sysdata[9][$ik])){
	if(($t=$sysdata[9][$ik])!=''){echo $t;}
...
<div class="bg_FFF_gray content_box loanbox lb<?php echo ($cnt+1); ?>"><div class="W800 Wmax100per mgnAuto textL">
...
<div class="clear"></div>
<table border="0" cellpadding="0" cellspacing="0" class="sp_tblbreak_limited W100per loan_step2"><tr>
<td class="box">
<div>
<table border="0" cellpadding="0" cellspacing="0" class="LIbox2"><tr>
...
<table border="0" cellpadding="0" cellspacing="0" class="LIbox2B"><tr>
...
・固定資産負担分
・仲介手数料
※概算費用見積の為、過不足が発生する可能性があります。'); ?></div>

<table border="0" cellpadding="0" cellspacing="0" class="LIbox3"><tr>
<td>－頭金</td>
...
<div>
<table border="0" cellpadding="0" cellspacing="0" class="LIbox4"><tr>
...
<table border="0" cellpadding="0" cellspacing="0" class="LIbox5"><tr>
<td><div><b>1回あたりボーナス時加算額</b></div>
※ボーナスは年2回で計算</td>
<td><input type="text" name="loan_input5" class="LI loan_input5 number_only" value="0"> 万円</td>
</tr></table>

<table border="0" cellpadding="0" cellspacing="0" class="LIbox6 sp_tblbreak_limited"><tr>
<td><b>金利</b></td>
<td>
<?php
$arr=array
(1=>array('変動金利（地方銀行など）',$loan_prm['変動金利'],'※お客様それぞれに合わせたプランを算出します。')
,2=>array('固定金利（フラット35）'	,$loan_prm['固定金利'],'※借入額の1割分は金利'.$loan_prm['1割分金利'].'％です。（月によって変動します）','month'=>true)
/*
1.35
*/
);
...
?>
</td><td><span class="fontP200 LH100 loan_input6 font_bold"><?php echo $arr[1][1]; ?></span> %</td>
</tr></table>
<?php
foreach($arr as $k => $v){
...
<table border="0" cellpadding="0" cellspacing="0" class="LIbox7"><tr>
<td><b>借入期間</b></td>
...
?>
<style>
.movie_pad{padding: min(100px,max(50px,10vw)) 0;}
.movie_box{
	width:800px;
	max-width: 100%;
	margin: auto;
...
*/
?>
<div class="movie_pad"><div class="movie_box"><div class="pos_rel">
...
foreach($sysdata[11] as $k => $v){
	...
	switch($v){
		...
		if(empty($sysdata[12][$cnt])){$sysdata[12][$cnt]='';}//PP7.0対応
...
<style>
.local_gallerybox.gb2{display: none;}
</style>
<?php
...
<div class="local_gaiyoubox"><table border="0" cellpadding="0" cellspacing="0" class="sp_tblbreak LH175">
<?php
	/*
			【物件概要のテーブル生成手順】
	...
	*/
	...
	foreach($arr as $k => $v){
		...
		//print_r($arr3);
	?>
<tr><td><div><?php echo $arr3[0]; ?></div></td><td><?php echo $arr3[1]; ?></td></tr>
	<?php
	}
?>
</table>
...
.shiryouDL_set .btn_bgLtoR > *:before{background-color: #FFF;}
.shiryouDL_set .btn_bgLtoR:hover > * > span{color: #00A0E9;}
.shiryouDL_set .btn_bgLtoR:hover > * > svg polyline{stroke: #00A0E9;}
</style>
...
<script>
$(window).load(function(){
	<?php if(empty($map_msg)){$map_msg='';} ?>
	infoWindow[<?php echo $map_msg; ?>].open(map,marker[<?php echo $map_msg; ?>]);
});
</script>
<div id="map" class="textL step3_vanish" style="height:600px;"></div>
</div>
<div class="local_shuuhenbox"><table border="0" cellpadding="0" cellspacing="0" class="sp_tblbreak LH175">
<?php
for($i=2;$i<count($sysdata[13]);$i++){
?>
<tr><td><?php echo $sysdata[13][$i]; ?></td><td><?php echo $sysdata[6][$i+4]; ?></td></tr>
<?php
}
?>
</table></div>
...
if(!empty($sysdata['banner'])){
	//print_r($sysdata[14]);
	if(!is_array($sysdata[14])){$sysdata[14]=array($sysdata[14]);}
	if(!is_array($sysdata[15])){$sysdata[15]=array($sysdata[15]);}
...
<div class="bg_FFF_gray content_box under_slidebox"><div class="top_ranking">
<h3>周辺の物件</h3>
<div class="r_slide">
<script>
$(window).load(function(){
...
.top_ranking .r_slide li td .box3 > span:nth-child(1) > font{display: inline-block;}
</style>
<?php
//リスト生成
$data_shitei=array();
...
foreach($sysdata_proto as $key => $sysdata){
	//指定のID以外除外
	if(empty($data_shitei[$sysdata[0]])){continue;}
	if(CMS_OPEN()){continue;}
	CMS_DATA_REPLACE();
...
<div class="s_set"><div class="pos_rel">
<ul>
<?php
$cnt=0;
$str='';
...
if(!is_array($v[19])){$v[19]=array($v[19]);}
if(!is_array($v[24])){$v[24]=array($v[24]);}
