...
<head>
	...
	<style>
		...
		.local_catch img[src*="toushin"] {
			width: 186px;
		}

		.local_catch img[src*="sdgs"] {
			width: 504px;
			margin-top: 20px;
		}
		...
		@media screen and (max-width: 999px) {
			...
			.local_sdgs_list .local_subt_beta {
				text-align: left;
			}
		}
		...
		.local_sdgs_list ul li:nth-child(n+2) {
			margin-top: 110px;
		}
		...
		.local_sdgs_list ul li .text .t_set {
			margin-top: 40px;
		}
		...
		.local_sdgs_list ul li .text .t_set h5 div {
			font-size: 80%;
		}
		...
		.local_sdgs_list ul li .text .icon {
			margin-top: 20px;
		}
		...
		.local_sdgs_list ul li.num03 .photo img[src*="-1"] {
			margin-right: auto;
		}

		.local_sdgs_list ul li.num03 .photo img[src*="-2"] {
			margin-left: auto;
		}
		...
		@media screen and (max-width: 999px) {
			...
			.local_sdgs_list ul li.num03 .photo img {
				width: 265px;
			}
...
<body class="borderbox">
	...
	<div align="center">
		...
		<div class="content_box">
			<div class="W1300 Wmax100per mgnAuto pos_rel local_mainpic">
...
持続的な成長と社会貢献を実現してまいります。'); ?></div>
		...
		<!-- *** -->
		<div class="content_box bg_FFF_gray local_sdgs">
			<div class="W1000 Wmax100per mgnAuto">
				<div class="subt">
					<h3>SDGsとは</h3><img src="images/common/logo-sdgs.svg">
				</div>
		...
		<!-- *** -->
		<div class="content_box local_sdgs_list">
			<div class="W1200 Wmax100per mgnAuto">
...
日本の森林を再生する',
							'subt'	=> '国産材利用の推進',
							'text'	=> '東新住建は創業以来50年間、国産材の利用した住まいづくりを推進しています。建築する住まいに国産材を利用することで、安定した木材需要を生み出し衰退しつつある林業をサポートし、日本の森の循環に貢献しています。',
...
さらに、低予算でバリアフリーの平屋住宅に住める「テイシャク」や戸建てマンションの「DUPレジデンス」など、豊富な商品ラインナップで多様化する社会に対応する家づくりを提供しています。',
						...
						5 => array(
							'title'	=> 'クリーンエネルギーを活用し、
環境にも家計にもやさしい住まい',
							'subt'	=> '太陽光発電標準搭載住宅・土地0円ハウス・樹流',
							'text'	=> '東新住建では、太陽光発電システムを標準搭載した分譲住宅を供給しています。発電した電気は売電や自家消費が可能で、電気代の節約にもなります。定期借地権を利用した土地0円ハウスでは、太陽光発電の売電収入で地代を支払える仕組みで幅広い世帯に住宅取得の間口を広げています。
...
<div class="photo">';
		...
		<div class="content_box">
			<div class="W1300 Wmax100per mgnAuto">
				<div class="top_search" style="padding:70px 0;">
