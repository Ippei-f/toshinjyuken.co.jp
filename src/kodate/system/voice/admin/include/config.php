...
require_once(dirname(__FILE__).'/../../../search/function/common-param.php');

//ページタイトル
$pagetitle='東新住建の家 お客様の声';
...
foreach($categoryArr['brand'] as $k => $v){
	$categoryArr['brand'][$k]=$v[0];//先頭の情報だけ使用
}

//保存用配列
$arr=COMMON_PARAM('dbDataStructure-voice');
...
//アップファイルの種類
$upfile_arr=COMMON_PARAM('upfile-voice');
