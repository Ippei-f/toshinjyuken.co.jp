...
<head>
	...
	<style>
		...
		.con_maint.c0 .catch br {
			display: none;
		}

		.con_maint.c0 .catch img {
			width: 936px;
			margin: auto;
		}
		...
		@media screen and (min-width: 1000px) {
			...
			.local_col2.ratio_4_6 li:nth-of-type(1) {
				width: 41.6667%;
			}

			.local_col2.ratio_4_6 li:nth-of-type(2) {
				max-width: 56.3333%;
			}
		}
		...
		.sonae3 .box6+.btn_bgLtoR:hover>*>span {
			color: #FFF;
		}

		.sonae3 .box6+.btn_bgLtoR>*>svg polyline {
			stroke: #000;
		}

		.sonae3 .box6+.btn_bgLtoR:hover>*>svg polyline {
			stroke: #FFF;
		}

		@media screen and (min-width: 1000px) {
			.sonae3 .box1>*:nth-child(1) {
				width: 51%;
			}

			.sonae3 .box1>*:nth-child(2) {
				width: 49%;
				padding: 2% 3% 0;
			}

			.sonae3 .box1>*:nth-child(2)>*:nth-child(1) {
				width: 390px;
			}

			.sonae3 .box1>*:nth-child(2)>*:nth-child(2) {
				width: 500px;
				margin: 1em 0;
			}

			.sonae3 .box1>*:nth-child(2)>*:nth-child(3) {
				width: 450px;
			}
			...
			.sonae3 .box3 img:nth-child(n+2) {
				margin-left: 0.5%;
			}

			.sonae3 .box4>*:nth-child(1) {
				width: 500px;
			}

			.sonae3 .box4>*:nth-child(2) {
				width: 140px;
				margin-left: 30px;
				margin-right: 80px;
			}

			.sonae3 .box4>*:nth-child(3) {
				width: 550px;
				text-align: left;
			}
		...
		@media screen and (max-width: 999px) {
			...
			.sonae3 .box6 li:nth-child(2n+2) {
				margin-left: 4%;
			}

			.sonae3 .box6 li:nth-child(n+3) {
				margin-top: 1em;
			}
		}
	</style>
...
<body class="borderbox">
	...
	<div align="center">
		...
		<div class="content_box">
			<div class="W1300 Wmax100per mgnAuto">
...
' . NUMBER_COMMA($comp_data['数値']['累計棟数']) . '棟の建築実績ノウハウが、お客様の想いを具現化します。',
		...
		<!-- *** -->
		<div class="content_box" style="min-height: 0;">
			<div class="W1300 Wmax100per mgnAuto">
...
液状化のリスクを抱える東海地方では、こうした教訓が生かされた家を選ぶことが大切です。',
		...
		?>
		<!-- sonae1 -->
		<div class="content_box" style="background-color: #F4F4F4;">
			<div class="W1300 Wmax100per mgnAuto" style="padding-top: 3em;">
		...
		<div class="content_box">
			<div class="W1300 Wmax100per mgnAuto">
				<ul class="local_col2">
					<li><img src="images/content/merit-kawaranai/point1.svg" class="point">
						<h4>地震で本当に怖いのは、<br>根こそぎ倒れる液状化</h4>
				...
				<ul class="local_col2">
					<li><img src="images/content/merit-kawaranai/point2.svg" class="point">
						<h4>愛知県の地盤は要注意。<br>だからこそ地盤対策が<br class="pc_vanish">必須です</h4>
				...
				<div class="top_search" style="padding: 3em 0;">
					<div class="btnbox num1"><?php
												//物件一覧ボタン用配列
				...
				<ul class="local_col2 ratio_4_6">
					<li>
						<h4>人と環境にやさしい最先端の<br>省エネルギー地盤改良技術。</h4>
				...
				<div class="top_search" style="padding: 3em 0 0;">
					<div class="btnbox num1"><?php
												echo EFFECT_BTN('物件検索', $top_bukken_btn['t'], $top_bukken_btn['a']);
												?></div>
				</div>
		...
		<!-- sonae2 -->
		<div class="content_box" style="background-color: #F4F4F4; margin-top: 4em;">
			<div class="W1300 Wmax100per mgnAuto" style="padding-top: 3em;">
		...
		<div class="content_box">
			<div class="W1300 Wmax100per mgnAuto">
				...
				<ul class="local_col2 ratio_4_6">
					<li>
						<h4>地震に強い2×4工法の<br>耐震性能を40％高めました。</h4>
						<div class="text">東新住建は、2×4パネルをさらに進化させた従来より耐力を約140％に高めた「壁量4.3倍」パネルを開発。高品質ステンレス釘の採用や、釘ピッチをより密にした仕様など、様々な工夫により耐振性能を向上させました。この新工法では、従来の「壁量3.0倍」から、「壁量4.3倍」にすることで1.4倍以上の耐力アップを実現しました。
							<img src="images/content/merit-kawaranai/pt2-1.svg" class="add">
						</div>
					</li>
...
*/
				...
				<ul class="local_col2 ratio_4_6">
					<li>
						...
						<div class="text">柱や梁の代わりに、均一サイズの角材と合板を接合して作られるパネルで、壁、床、天井、屋根などを構築する2×4工法。その強さは、パネル自体の品質に支えられています。東新住建は本社が位置する稲沢市に自社パネル工場を建設。徹底した品質管理のもと、高品質なパネルを安定供給できる体制を整えています。
							<img src="images/content/structure/2023/pt2-2.svg" class="add">
						</div>
					</li>
				...
				<div class="bg_FFF_gray W1200 Wmax100per mgnAuto" style="border: solid 1px #888; padding: 2em;margin-top: 3em; font-size: 80%;">
					<ul class="local_col2 ratio_4_6" style="margin-top: 0;">
						<li>
							<h4>東新住建は2×4工法を<br class="pc_vanish">いち早く導入。<br>自社社屋でトライアルし、<br class="pc_vanish">その強さを実証。</h4>
		...
		<div class="sonae3">
			...
			<div class="content_box" style="background-color: #F4F4F4;">
				<div class="W1300 Wmax100per mgnAuto" style="padding-top: 60px; padding-bottom: 45px;">
					<h3>環境共生住宅の普及</h3>
					<div class="catch pc_br_del">自然エネルギー活用と<br>地球環境への貢献</div>
				</div>
			</div>
			<div class="content_box">
				<div class="W1200 Wmax100per mgnAuto" style="padding-top: 45px;">
					...
					<ul class="flex box2">
						<li>
							<div>環境共生住宅の開発</div><img src="images/content/structure/p3-3-1.jpg">
							<div class="textL LH175">ウイルスやアレルギーから守る自然換気システムを採用した、人と環境に優しい環境共生住宅の開発しています。</div>
						</li>
						<li>
							<div>国産木材の活用</div><img src="images/content/structure/p3-3-2.jpg">
							<div class="textL LH175">H26年より全棟に国産材2×4を標準使用。国の重要課題である国産材の普及に貢献し、これまでに約2,000棟建築しています。</div>
						</li>
						<li>
							<div>地元の天然資源の活用</div><img src="images/content/structure/p3-3-3.jpg">
							<div class="textL LH175">「砕石パイル工法」で使用しているのは、地元の天然石。セメントを使用しない地球環境に優しい技術です。</div>
						</li>
						<li>
							<div>自然エネルギーの活用</div><img src="images/content/structure/p3-3-4.jpg">
							<div class="textL LH175">太陽光発電システムを標準仕様とした、発電シェルターハウスを展開。エネルギーを自給自足するライフスタイルの提案をおこなっています。</div>
						</li>
					</ul>
				</div>
			</div>
...
*/
			...
			<div class="content_box">
				<div class="W1300 Wmax100per mgnAuto">
					<div class="top_search" style="padding:0;">
						<div class="btnbox num1"><?php
													echo EFFECT_BTN('物件検索', $top_bukken_btn['t'], $top_bukken_btn['a']);
													?></div>
					</div>
