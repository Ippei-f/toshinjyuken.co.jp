...
<!-- *** -->
<div class="content_box"><div class="W1000 Wmax100per mgnAuto"><?php /* style="background-color: #DEF;"*/ ?>
<?php
...
foreach($sysdata_proto as $key => $sysdata){
	...
	if($get_arr['c']!=''){
		if($get_arr['c']!=$sysdata[8]){continue;}
	}
	//日付指定がある場合、指定以外を除く
	if($get_arr['d']!=''){
...
<table border="0" cellpadding="0" cellspacing="0" class="W100per bg_greenD" style="min-height:50px;background-color: #F63402;color: #FFF;"><tr>
