...
<head>
	...
	<style>
		...
		@media screen and (max-width: 999px) {
			.voice_list {
				max-width: 655px;
				gap: 35px calc(1% * 35 / 6.55);
			}

			.voice_list li {
				max-width: calc(1% * 310 / 6.55);
			}
		}
