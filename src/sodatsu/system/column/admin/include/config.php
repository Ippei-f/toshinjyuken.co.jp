...
//アップファイルの種類
$upfile_arr=COMMON_PARAM('upfile-column');
$comment_name_arr=array('comment','naiyou_text','naiyou_type','imgsize_f','imgsize_n');

//保存用配列
$dbDataStructure	= COMMON_PARAM('dbDataStructure-column');
