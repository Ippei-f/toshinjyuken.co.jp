...
function COMMON_PARAM($k){
	...
	, 8=>'gaiyou_text'		//★物件概要・テキスト
	, 9=>'kukaku_type'		//★区画・項目タイプ
	,10=>'newmark'				//★NEWマーク
	,11=>'gallery_type'		//★ギャラリー・項目タイプ
	,12=>'gallery_text'		//★ギャラリー・テキスト	
	,13=>'access_map'			//★アクセス・埋め込みマップ
	,14=>'kukaku_text'		//★区画・テキスト
	,15=>'kukaku_chintai'	//★区画・賃貸査定
	,16=>'access_near'		//★アクセス・周辺環境
	,17=>'area1'					//★エリア
	,18=>'area2'					//エリア・小区分（未使用）
	,19=>'icon'						//★アイコン
	,20=>'kukaku_outlet'	//区画・アウトレットボタン（未使用）
	...
	,11=>'news_newmark'	//NEWマーク
		...
		break;
		case 'dbDataStructure-column'://登録データ（カラム順の変更厳禁。追加の場合は末尾に）
			$res=array('id','up_ymd','title','category','url','window','comment','public_flag'
