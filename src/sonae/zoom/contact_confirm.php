...
?>
		...
		<title>オンライン面談受付|土地を持たない不動産投資｜SONAE</title>
			...
			<div class="formColumn">
				...
				<div class="inputBlock">
					...
					<div class="formRow" id="namaeRow">
						...
						<div class="cont">
							<?= $pubview->encode_html($arrBfContactForm["date"]["value"])?>
						</div>
					</div>
					...
					<div class="formRow" id="namaeRow">
						...
						<div class="cont">
							<?= $pubview->encode_html($arrBfContactForm["select"]["value"])?>
						</div>
					</div>
				...
				<div style="text-align: center;">
					...
					<form action="contact_send.php" method="post">
						...
						<div class="sendBtnBox">
							<a href="/sonae/zoom/contact.php" class="modoru">戻る</a>
