	...
	<body>
		...
		<script>//bodyに各ページ固有のclassを設定
			document.addEventListener('DOMContentLoaded', function () {
				document.body.classList.add('page-inquiry', 'confirmPage', 'underPage');
			});
		</script>
		...
		<div class="contentWrapper">
				...
				<div class="contBlock headerBlock">
					<div class="innerWrapper">
						<h2 class="secHeader">
							...
							<p class="main pict"><img src="../common/images/title-inquiry.svg" alt="INQUIRY"></p>
						</h2>
					</div><!--innerWrapper-->
				</div><!--contBlock-->
			</section><!--pageHeadSec-->
			...
			<div class="formColumn">
				<p class="confirmCap">ご入力内容確認</p>

				<div class="inputBlock">
					<div class="formRow" id="puposeRow">
						<p class="formTopicHeader">お問い合わせ内容</p>
						<div class="cont">
								<?= $pubview->encode_html($arrBfContactForm["radio"]["value"])?>
						</div>
					</div>
				...
				<div style="text-align: center;">
					...
					<form action="contact_send.php" method="post">
						...
						<div class="sendBtnBox">
							<a href="/sonae/inquiry/contact.php" class="modoru">戻る</a>
							<input type="submit" class="bbbbb" value="送信する"/>
						</div><!--sendBtnBox-->
					</form>
