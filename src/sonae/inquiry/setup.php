...
//メール送信者
define('PUB_MAIL_FROM_NAME',		'東新住建 アパート経営【SONAE】 お問い合わせ');
define('PUB_MAIL_FROM_ADDRESS',		'support@toshinjyuken.co.jp');
//define('PUB_MAIL_FROM_ADDRESS',		'design@birth.ne.jp');
...
//define('PUB_MAIL_TO_ADDRESS',		'design@birth.ne.jp','kato@birth.ne.jp');
...
//タイトル
$strContactMailTitle = "###txt_name### 様よりお問い合わせがありました。";
...
//タイトル
$strThanksMailTitle = "###txt_name### 様、お問い合わせありがとうございます";

//本文
$strThanksMailBody = <<<EOT
この度は、東新住建・SONAEのお問い合わせをいただき誠にありがとうございます。
...
$arrBfContactForm["agreechk"]["check"] =		"";

$arrBfContactForm["select"]["title"] =			"セレクトボックス";
$arrBfContactForm["select"]["name"] =			"sel_select";
$arrBfContactForm["select"]["check"] =			"";

$arrBfContactForm["radio"]["title"] =			"お問い合わせ内容";
$arrBfContactForm["radio"]["name"] =			"rad_radio";
$arrBfContactForm["radio"]["check"] =			"c1";
