...
//メール送信者
define('PUB_MAIL_FROM_NAME',		'東新住建 アパート経営【SONAE】新規メンバーシップ登録');
...
//タイトル
$strContactMailTitle = "###txt_name### 様より新規メンバーシップ登録のお申し込みがありました。";

//本文
$strContactMailBody = <<<EOT
SONAE LPよりお問い合わせがありました。
お問い合わせメールの内容は以下となります。
...
//タイトル
$strThanksMailTitle = "###txt_name### 様、新規メンバーシップ登録へのお申し込みありがとうございます。";

//本文
$strThanksMailBody = <<<EOT
この度は、東新住建【SONAE】に新規メンバーシップ登録へお申し込みいただき誠にありがとうございます。
本メールは、お客さまのお問い合わせの受付が、以下の内容で完了しましたことをお知らせするものです。

今後、「メンバーシップ限定公開物件」の閲覧の際は
下記の「ユーザー名」と「パスワード」にて認証ログインをお願いします。

ユーザー名: tj-sonae 
パスワード: toshinjyuken2025 
...
define('PUB_MAIL_CONFIRM_RETURN_URL', './contact' . PUB_SYSTEM_EXTENSION);
...
$arrBfContactForm["jobs"]["title"] =			"職業";
$arrBfContactForm["jobs"]["name"] =				"sel_jobs";
$arrBfContactForm["jobs"]["check"] =			"c1";

$arrBfContactForm["age"]["title"] =				"年齢";
$arrBfContactForm["age"]["name"] =				"sel_age";
$arrBfContactForm["age"]["check"] =				"c1";

$arrBfContactForm["income"]["title"] =				"年収（世帯年収）";
$arrBfContactForm["income"]["name"] =				"sel_income";
$arrBfContactForm["income"]["check"] =				"c1";

$arrBfContactForm["funds"]["title"] =			"自己資金";
$arrBfContactForm["funds"]["name"] =			"txt_funds";
$arrBfContactForm["funds"]["check"] =			"c1";

$arrBfContactForm["budget"]["title"] =			"今回予定している投資額";
$arrBfContactForm["budget"]["name"] =			"txt_budget";
$arrBfContactForm["budget"]["check"] =			"c1";

$arrBfContactForm["estate"]["title"] =			"保有不動産";
$arrBfContactForm["estate"]["name"] =			"sel_estate";
$arrBfContactForm["estate"]["check"] =			"c1";



$arrBfContactForm["radio"]["title"] =			"お問い合わせ内容";
