...
<a href="https://www.toshinjyuken.co.jp/teishaku-portal/member.php" class="btn_member"><span class="icon"><img src="' . $kaisou . 'images/common/icon-member.svg"></span><span class="label">会員登録</span></a>
...
// SATORI クリエイティブ（teishaku-portal 用）
$temp_bodyend .= '
<div id="satori__creative_container">
  <script id="-_-satori_creative-_-" src="//delivery.satr.jp/js/creative_set.js?d=20251119" data-key="f70e4b801e47c033"></script>
</div>
' . chr(10);
