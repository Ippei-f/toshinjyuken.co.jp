...
switch(true){
	...
	$democheck='showa';
	if($_GET['demounlock']=='ok'){$democheck='';}
	break;
	default:
	$democheck='';
}
...
$userid[]   = 'toushin_t';// ログインID
$password[] = 'teishaku2022ts';// パスワード
...
$categoryArr = COMMON_PARAM('news_cate');
$categoryArr_news=COMMON_PARAM('news_page_cate');
/*
...
//アップファイルの種類
$upfile_arr=COMMON_PARAM('upfile-news');
$comment_name_arr=array('comment','news_text','news_type');

//保存用配列
$dbDataStructure	= COMMON_PARAM('dbDataStructure-news');
