...
<style>
.wideslider:not(.loadend) .wideslider_wrap{display: none;}
</style>
<script>
...
function WIDESLIDER_CATCH_ONOFF(){
	...
	if(c.indexOf('s-0yen_select.jpg',0)>-1){f=true;}
	if(f){$('.top_slider .catch').fadeOut();}
	else{$('.top_slider .catch').fadeIn();}
}
</script>
</head>
...
?>
<!-- *** -->
<div class="pc_content_box"><div class="Wbase W1200">
<?php
...
<!-- *** -->
<div class="content_box bg_FFD"><div class="Wbase W1200">
<?php echo CONTENT_PAD(35); ?>
...
<!-- *** -->
<div class="content_box bg_DEF"><div class="Wbase W1200">
<?php echo CONTENT_PAD(70,'sp/2'); ?>
<h2 class="subt_deco">
...
<div class="fontP275 sp_fontP175 pc_br_del"><span class="beta"><div>3軒に1軒が空き家になる</div><div></div></span><br>と予想され、</div>
...
<li><div class="icon"><img src="images/top/life-icon-1.svg"><img src="images/top/life-num-1.svg"></div><?php
...
<!-- *** -->
<div class="content_box bg_FD0"><div class="Wbase W1200">
...
<!-- *** -->
<div class="content_box bg_DEF"><div class="Wbase W900">
<?php echo CONTENT_PAD(60); ?>
<h2 class="subt_deco" style="color: #1E1E1E;">
<div class="fontP200 sp_fontP175 pc_br_del sp_LH150"><span class="beta"><div>資産価値が</div><div class="pc_vanish" style="height:8px;"></div></span><br><span class="fontP150 blue beta" style="margin: 0 0.25em;"><div>下落し続ける土地</div><div class="pc_vanish" style="height:8px;"></div></span><br><span class="beta"><div>所有し続けますか？</div><div class="pc_vanish" style="height:8px;"></div></span></div>
</h2>
...
//----------------
,3=>array('h3'=>'見学から２週間で契約、とても満足しています'
				 ,'h4'=>'マンションから平屋への住み替え'
...
,4=>array('h3'=>'土地を所有しない定期借地権はむしろ好都合'
				 ...
				 */
//----------------
,5=>array('h3'=>'自分の時間を存分に楽しく過ごすための家'
				 ,'h4'=>'テイシャクは時代に合った仕組み'
...
<div class="top_Bline_subt sp_fontP090"><h3>こんな人に選ばれています</h3></div>
<?php echo CONTENT_PAD(30,'sp/2'); ?>
<div class="vanish_branch">
...
<span class="beta"><div>おふたりのライフワークに合わせた</div><div></div></span><?php echo CONTENT_PAD(10,'sp/2'); ?><span class="beta"><div>フレキシブルで可変性のある間取り</div><div></div></span>
</div>
</h2>
